<template>
  <div class='EnbItemView02'>
    ...
    <div class="cont">
      ...
      <div class="qtda-btn">
        <div class="qtda">
          <enb-setQtda02 v-model:qtda="qtda"/> 
        </div>
        <div class="btn">
...
import EnbSetQtda02 from './Produto/EnbSetQtda02'
import { Carousel, Slide, Navigation, Pagination } from 'vue3-carousel'
import SelectProp from './Produto/SelectProp'
export default {
  name: 'EnbItemView02',
  components: { VueImageZoomer, EnbSetQtda02, Carousel, Slide, Navigation, Pagination, SelectProp },
  computed: {
